...
function Hero() {
  return (
    <div id="heroComponents" className="hero d-flex flex-column justify-content-center">
      <div className="d-flex flex-column justify-content-center align-items-right ms-5 ps-5">

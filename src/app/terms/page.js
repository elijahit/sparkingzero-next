...
export default async function Home() {
  ...
  const schemaSite = {
    ...
    name: "Sparking Zero Italia - Termini di Servizio",
    description: "Termini di Servizio di Sparking Zero Italia",
    isPartOf: {
      "@type": "WebSite",
  ...
  return (
    <>
      ...
      <main>
        {/* HERO SECTION */}
        <Hero />
        <h1 className="d-none">Termini di Servizio di SparkingZero.it</h1>
        {/* FIRST SECTION DESKTOP*/}
        <section className="container mt-4 d-none d-lg-block">
          <h1 className="text-center">Termini di Servizio di SparkingZero.it</h1>
          <p>
          ...
          <p>
            ...
            SparkingZero.it sono di proprietà dei rispettivi titolari. Non è
          ...
          <p>
            ...
            all&apos;indirizzo support@SparkingZero.it.
          </p>
        </section>
      </main>
      {/* FOOTER */}

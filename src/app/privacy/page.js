...
export default async function Home() {
  ...
  const schemaSite = {
    ...
    name: "Sparking Zero Italia - Privacy Policy",
    description:
      "Privacy Policy di Servizio di Sparking Zero Italia",
    isPartOf: {
      "@type": "WebSite",
    ...
    publisher: {
      ...
      keywords:
        "sparkingzero, sparkingzeroitalia, sparking, zero, italia, dragonball",
      founder: [
        {
          "@type": "Person",
          name: "Gabriele Mario Tosto",
          description:
            "CEO e Developer di Sparking Zero Italia, lavora attualmente come sviluppatore attivo.",
  ...
  return (
    <>
      ...
      <main>
        {/* HERO SECTION */}
        <Hero />
        <h1 className="d-none">Privacy Policy di Sparking Zero Italia</h1>
        ...
        <section className="container mt-4 d-none d-lg-block">
          ...
          <p>
            Benvenuti su Sparking Zero Italia (SparkingZero.it). La tua privacy è
          ...
          <p>
            SparkingZero.it è un portale dedicato al gioco e agli aggiornamenti
            ...
            <a href="mailto:info@SparkingZero.it">info@SparkingZero.it</a>.
          </p>
...
async function getData() {
  try {
    const res = await fetch(`http://localhost:3001/api/postNews?limit=2`, {
      next: { revalidate: 1 },
    });
...
async function getDataAll() {
  try {
    const res = await fetch(`http://localhost:3001/api/postNews`, {
      next: { revalidate: 1 },
    });

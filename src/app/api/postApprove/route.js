...
export async function POST(request) {
  ...
  fetch(`https://bing.com/indexnow?url=https://SparkingZero.it/posts/${uri_article}&key=2b74988ce52cfaf5ab0e7e1d10a8d8fc`);
  ...
  jwtClient.authorize(function (err, tokens) {
    ...
    let options = {
      ...
      json: {
        "url": `https://SparkingZero.it/posts/${uri_article}`,
        "type": "URL_UPDATED"
      }
    };
